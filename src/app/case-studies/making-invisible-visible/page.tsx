...
//   title: 'Case Study: Financial Transparency Success | NewGen Strata Services',
//   description: 'How NewGen uncovered $85K in unexplained expenses and restored financial transparency to a 72-unit owners corporation.',
// }
...
//       description: 'Recovered through audit'
//     },
//     {
//       icon: TrendingDown,
//       value: '32%',
//       label: 'Annual Fees Reduced',
//       description: 'Better supplier management'
//     },
//     {
//       icon: CheckCircle,
//       value: '100%',
//       label: 'Financial Transparency',
//       description: 'All expenses tracked'
//     },
//     {
//       icon: Eye,
//       value: '24/7',
...
//     title: 'The Challenge',
//     icon: AlertTriangle,
//     description: 'A 72-unit owners corporation experienced 45% levy increases over three years with no explanation.',
//     keyIssues: [
//       'Quarterly levies increased 45% in 3 years',
//       'Building maintenance declining',
...
//     title: 'Our Solution',
//     icon: Target,
//     description: 'Comprehensive financial review and transparency initiative.',
//     actions: [
//       {
//         phase: 'Discovery & Audit (Weeks 1-4)',
//         steps: [
//           'Conducted 3-year financial audit',
//           'Identified $85K in questionable charges',
//           'Documented all supplier contracts',
//           'Interviewed committee members',
//           'Created detailed expense breakdown'
//         ]
//       },
//       {
//         phase: 'Correction (Weeks 5-12)',
//         steps: [
//           'Recovered $62,000',
//           'Competitive tendering implemented',
//           'Renegotiated all major contracts',
//           'Switched insurance providers',
//           'Established vetted tradesperson network'
//         ]
//       }
//     ]
//   },
...
//     title: 'The Results',
//     icon: CheckCircle,
//     description: 'Reduced costs while improving service quality.',
//     outcomes: [
//       {
//         metric: 'Cost Recovery',
//         value: '$62,000 recovered',
//         impact: 'Funds to reserve'
//       },
//       {
//         metric: 'Annual Savings',
//         value: '$47,000 per year',
//         impact: '32% expense reduction'
//       },
//       {
//         metric: 'Levy Reduction',
//         value: '18% decrease',
//         impact: '$720 per owner annually'
//       }
//     ]
//   },

//   testimonial: {
//     quote: "NewGen found $85,000 in unexplained expenses and now we can see every transaction in real-time. We're paying less and getting better service.",
...
//         description: 'Real-time visibility increases confidence.'
//       },
//       {
//         title: 'Audits Reveal Hidden Costs',
//         description: 'Regular audits uncover overcharging.'
//       }
//     ]
//   }
// }
...
const caseStudyData = {
  hero: {
    ...
    readTime: '7 min read',
    date: 'February 2024',
    image: '/images/case-studies/financial-transparency.jpg', // Add your image
    tags: ['Financial Management', 'Transparency', 'Audit']
  },
