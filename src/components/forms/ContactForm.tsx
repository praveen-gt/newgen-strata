...
//             {/* Company */}
//             <div className="space-y-2">
//                 <Label htmlFor="company" className='text-gray-500'>Company/Organization</Label>
//                 <Input
//                     id="company"
//                     {...register('company')}
...
//             <div className="grid md:grid-cols-2 gap-4">
//                 <div className="space-y-2">
//                     <Label htmlFor="propertyType" className='text-gray-500'>Property Type *</Label>
...
//                 </div>
//                 <div className="space-y-2">
//                     <Label htmlFor="units" className='text-gray-500'>Number of Units</Label>
//                     <Input
//                         id="units"
//                         type="number"
//                         {...register('units')}
...
//             {/* Current Manager */}
//             <div className="space-y-2">
//                 <Label htmlFor="currentManager" className='text-gray-500'>Current Strata Manager (if any)</Label>
//                 <Input
//                     id="currentManager"
...
//             {/* Service Type */}
//             <div className="space-y-2">
//                 <Label htmlFor="serviceType" className='text-gray-500'>Service Required *</Label>
