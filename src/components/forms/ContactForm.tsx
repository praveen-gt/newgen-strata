...
// Simple validation schema - only 5 fields
const contactFormSchema = z.object({
  firstName: z.string()
    .min(2, 'First name must be at least 2 characters')
    .max(50, 'First name must be less than 50 characters'),
    ...
    <form onSubmit={handleSubmit(onSubmit)} className="space-y-6" noValidate>
      ...
      <div className="grid md:grid-cols-2 gap-4">
        <div className="space-y-2">
          ...
          <Input
            ...
            {...register('firstName')}
            placeholder="John"
            className={`h-12 ${errors.firstName ? 'border-red-500 focus:ring-red-500' : 'focus:ring-primary focus:border-primary'}`}
            aria-invalid={errors.firstName ? 'true' : 'false'}
            aria-describedby={errors.firstName ? 'firstName-error' : undefined}
          />
          {errors.firstName && (
        ...
        <div className="space-y-2">
          ...
          <Input
            ...
            {...register('lastName')}
            placeholder="Smith"
            className={`h-12 ${errors.lastName ? 'border-red-500 focus:ring-red-500' : 'focus:ring-primary focus:border-primary'}`}
            aria-invalid={errors.lastName ? 'true' : 'false'}
            aria-describedby={errors.lastName ? 'lastName-error' : undefined}
          />
          {errors.lastName && (
      ...
      <div className="grid md:grid-cols-2 gap-4">
        <div className="space-y-2">
          ...
          <Input
            ...
            {...register('email')}
            placeholder="john.smith@example.com"
            className={`h-12 ${errors.email ? 'border-red-500 focus:ring-red-500' : 'focus:ring-primary focus:border-primary'}`}
            aria-invalid={errors.email ? 'true' : 'false'}
            aria-describedby={errors.email ? 'email-error' : undefined}
          />
          {errors.email && (
        ...
        <div className="space-y-2">
          ...
          <Input
            ...
            className={`h-12 ${errors.phone ? 'border-red-500 focus:ring-red-500' : 'focus:ring-primary focus:border-primary'}`}
            aria-invalid={errors.phone ? 'true' : 'false'}
            aria-describedby={errors.phone ? 'phone-error' : undefined}
          />
          {errors.phone && (
      ...
      <div className="space-y-2">
        ...
        <Textarea
          id="message"
          {...register('message')}
          placeholder="Tell us how we can help you with your strata management needs..."
          rows={6}
          className={`resize-none ${errors.message ? 'border-red-500 focus:ring-red-500' : 'focus:ring-primary focus:border-primary'}`}
          aria-invalid={errors.message ? 'true' : 'false'}
          aria-describedby={errors.message ? 'message-error' : undefined}
        />
        {errors.message && (
      ...
      <div className="pt-4">
        <Button
          type="submit"
          disabled={isSubmitting}
          className="w-full h-14 text-base font-semibold bg-gradient-to-r from-primary to-secondary hover:from-primary/90 hover:to-secondary/90 text-white shadow-lg hover:shadow-xl transition-all duration-300"
        >
          {isSubmitting ? (
            <>
              <Loader2 className="mr-2 h-5 w-5 animate-spin" />
        ...
        <div className="mt-6 text-center space-y-3">
          <p className="text-sm text-gray-600">
            We typically respond within <strong className="text-brand-dark">2 hours</strong> during business hours
          </p>
          <p className="text-xs text-gray-500">
            Monday to Friday, 9:00 AM - 5:00 PM AEST
          </p>
