...
const stats = [
  { icon: Building2, value: '1,800+', label: 'Properties managed' },
  { icon: Users, value: '15,000+', label: 'Residents served' },
  { icon: MapPin, value: '25+', label: 'Suburbs covered' }
]

const serviceAreas = [
  'Melbourne CBD', 'Inner East', 'Inner West', 'Inner North', 
  'Inner South', 'Eastern Suburbs', 'Western Suburbs', 'Northern Suburbs'
]
        ...
        >
          ...
          <motion.div variants={fadeInUp} className="text-center mb-16">
            ...
            <p className="text-lg text-slate-600 max-w-2xl mx-auto">
              Professional strata management across all Melbourne metropolitan areas
            </p>
          </motion.div>
          ...
          <motion.div variants={fadeInUp} className="mb-16">
            <Card className="border-0 shadow-xl overflow-hidden py-0">
              <CardContent className="p-0">
                <div className="relative h-[400px] bg-gradient-to-br from-slate-100 via-slate-50 to-slate-100">
                  {/* Map Placeholder */}
                  <div className="absolute inset-0 flex items-center justify-center">
                    <div className="text-center">
                      ...
                      <p className="text-slate-600 mb-6 max-w-md">
                        Comprehensive service across all major Melbourne areas
                      </p>
            ...
            <div className="flex flex-wrap justify-center gap-3">
              {serviceAreas.map((area) => (
                <Badge 
                  key={area} 
                  variant="secondary" 
                  className="px-4 py-2 text-sm font-normal bg-slate-100 text-slate-700 hover:bg-slate-200"
                >
                  {area}
                </Badge>
              ))}
